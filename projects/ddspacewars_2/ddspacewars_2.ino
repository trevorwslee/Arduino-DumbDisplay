...
#include "ddjoystick.h"
  ...
  joystick = new DecodedJoystick(false);
  buttons = new DecodedJoystick(true);
  ...
  ButtonJoystick *joystick = new ButtonJoystick(upTracker, rightTracker, downTracker, leftTracker, NULL);
