# DumbDisplay Arduino Library (v0.9.9-r55)
...
- [DumbDisplay Arduino Library (v0.9.9-r55)](#dumbdisplay-arduino-library-v099-r55)
  - [Enjoy](#enjoy)
...
v0.9.9-r54
  - added "level rotate" option
  - ported more to MicroPython
  - bug fix
